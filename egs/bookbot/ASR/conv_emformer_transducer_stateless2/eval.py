...
from asr_datamodule import BookbotAsrDataModule
from austalk_words_mq import AusTalkWordsMQ
...
from sc_cw_children import SCCWChildren
from timit_asr_gruut import TIMITASRGruut
...
def main():
    parser = get_parser()
    BookbotAsrDataModule.add_arguments(parser)
