...
def get_model(params: AttributeDict) -> nn.Module:
    assert params.use_transducer or params.use_otc, (
        f"At least one of them should be True, "
        f"but got params.use_transducer={params.use_transducer}, "
        f"params.use_otc={params.use_otc}"
    )
...
def compute_loss(
    ...
    if params.use_otc:
        ...
        loss += params.otc_loss_scale * otc_loss
...
def run(rank, world_size, args):
    ...
    train_dl = asr_data_module.train_dataloaders(
