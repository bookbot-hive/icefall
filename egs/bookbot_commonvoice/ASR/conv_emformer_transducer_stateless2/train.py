...
from commonvoice_phonemes import CommonVoicePhonemes
...
def run(rank, world_size, args):
    ...
    train_cuts = train_bookbot_cuts + train_commonvoice_cuts
    ...
    train_dl = asr_datamodule.train_dataloaders(train_cuts)
