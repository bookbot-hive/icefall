...
Usage:
(1) greedy search
./pruned_transducer_stateless7_multi/decode.py \
    --epoch 28 \
    --avg 15 \
    --exp-dir ./pruned_transducer_stateless7_multi/exp \
    --max-duration 600 \
...
def get_parser():
    ...
    parser.add_argument(
        "--exp-dir",
        type=str,
        default="pruned_transducer_stateless7_multi/exp",
...
def main():
    ...
    if "ngram" in params.decoding_method or "LODR" in params.decoding_method:
        lm_filename: str = f"{params.tokens_ngram}gram.fst.txt"
