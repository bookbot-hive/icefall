...
def save_results(
    ...
    for key, results in results_dict.items():
        recog_path = params.res_dir / f"recogs-{test_set_name}-{key}-{params.suffix}.txt"
    ...
    errs_info = params.res_dir / f"wer-summary-{test_set_name}-{key}-{params.suffix}.txt"
...
def main():
    ...
    test_cuts_gigaspeech = multidataset.test_cuts_gigaspeech()
    test_cuts_bookbot = multidataset.test_cuts_bookbot()
    test_cuts_bookbot = test_cuts_bookbot.filter(remove_short_and_long_utt)

    test_dl_gigaspeech = asr_data_module.test_dataloaders(test_cuts_gigaspeech)
    test_dl_bookbot = asr_data_module.test_dataloaders(test_cuts_bookbot)

    test_sets = ["test-gigaspeech", "test-bookbot"]
    test_dl = [test_dl_gigaspeech, test_dl_bookbot]
