...
def get_parser():
    ...
    parser.add_argument("--base-lr", type=float, default=0.045, help="The base learning rate.")
    ...
    for batch_idx, batch in enumerate(train_dl):
        ...
        if batch_idx % params.log_interval == 0:
            ...
            logging.info(
                ...
                f"lr: {cur_lr:.2e}, " + (f"grad_scale: {scaler._scale.item()}" if params.use_fp16 else "")
            )
...
def run(rank, world_size, args):
    ...
    def remove_short_and_long_utt(c: Cut):
        ...
        # https://github.com/k2-fsa/icefall/issues/1182#issuecomment-1742203390
        if T * 2 // 3 < len(tokens):
            # logging.warning(
    ...
    train_dl = asr_data_module.train_dataloaders(train_cuts, sampler_state_dict=sampler_state_dict)
