...
def modified_beam_search_lm_rescore_LODR(
    ...
    for seq in candidate_seqs:
        tokens = " ".join([lexicon.token_table[i] for i in seq])
...
def fast_beam_search_with_nbest_rescoring(
    ...
    word_list: List[List[str]] = [
        [lexicon.token_table[i] for i in l] for l in token_list
    ]
...
def fast_beam_search_with_nbest_rnn_rescoring(
    ...
    # Now RNN-LM
    blank_id = model.decoder.blank_id
    sos_id = lexicon.token_table["sos_id"]
    eos_id = lexicon.token_table["eos_id"]
